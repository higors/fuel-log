...
class ProcessTripSpec extends Specification {
    ...
    def "Process trip when efficiency is #scenario "() {
        ...
        "good with higher efficiency"  | TripTemplates.CAR_MODEL_320_DISTANCE_100_LITERS_10 | BigDecimal.valueOf(8)     | "Parab�ns voc� � um amigo do meio ambiente"
        "good with exactly efficiency" | TripTemplates.CAR_MODEL_320_DISTANCE_100_LITERS_10 | BigDecimal.valueOf(10)    | "Parab�ns voc� � um amigo do meio ambiente"
        "bad"                          | TripTemplates.CAR_MODEL_320_DISTANCE_100_LITERS_10 | BigDecimal.valueOf(11)    | "Que pena o seu consumo foi horr�vel, ande mais de vagar da pr�xima vez"
    }
