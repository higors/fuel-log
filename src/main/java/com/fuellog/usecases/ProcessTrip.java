...
public class ProcessTrip {
    ...
    private static final String GOOD_MESSAGE = "Parabéns você é um amigo do meio ambiente";
    private static final String BAD_MESSAGE = "Que pena o seu consumo foi horrível, ande mais de vagar da próxima vez";
